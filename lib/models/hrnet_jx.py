...
class HighResolutionNet(nn.Module):
    ...
    def __init__(self, config, **kwargs):
        ...
        self.stage3_18_18_1 = nn.Sequential(nn.Conv2d(18,18, 3, 2,1,bias=False),
                        BatchNorm2d(18, momentum=0.1), nn.ReLU(inplace=False))
        ...
        self.stage4_36_36_1 = nn.Sequential(nn.Conv2d(36,36, 3, 2,1,bias=False),
                        BatchNorm2d(36, momentum=0.1), nn.ReLU(inplace=False))
    ...
    def forward(self, x):
        ...
        # stage 2 fuse
        fuse1 = x1 + F.interpolate(self.stage2_36_18(x2),size=[64,64], mode='nearest')
        # return fuse1
        ...
        # stage 3 fuse
        fuse1 = x1 + F.interpolate(self.stage3_36_18_1(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage3_72_18_1(x3),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage3_18_36_1(x1)
        fuse2 = fuse2 + F.interpolate(self.stage3_72_36_1(x3),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        # stage 3 fuse
        fuse1 = x1 + F.interpolate(self.stage3_36_18_2(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage3_72_18_2(x3),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage3_18_36_2(x1)
        fuse2 = fuse2 + F.interpolate(self.stage3_72_36_2(x3),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        # stage 3 fuse
        fuse1 = x1 + F.interpolate(self.stage3_36_18_3(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage3_72_18_3(x3),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage3_18_36_3(x1)
        fuse2 = fuse2 + F.interpolate(self.stage3_72_36_3(x3),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        # stage 3 fuse
        fuse1 = x1 + F.interpolate(self.stage3_36_18_3(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage3_72_18_4(x3),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage3_18_36_4(x1)
        fuse2 = fuse2 + F.interpolate(self.stage3_72_36_4(x3),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        # stage 4 fuse
        fuse1 = x1 + F.interpolate(self.stage4_36_18_1(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage4_72_18_1(x3),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage4_144_18_1(x4),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage4_18_36_1(x1)
        fuse2 = fuse2 + F.interpolate(self.stage4_72_36_1(x3),size=[32,32], mode='nearest')
        fuse2 = fuse2 + F.interpolate(self.stage4_144_36_1(x4),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        fuse3 = fuse3 + x3
        fuse3 = fuse3 + F.interpolate(self.stage4_144_72_1(x4),size=[16,16], mode='nearest')
        fuse3 = self.relu(fuse3)
        ...
        # stage 4 fuse
        fuse1 = x1 + F.interpolate(self.stage4_36_18_2(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage4_72_18_2(x3),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage4_144_18_2(x4),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage4_18_36_2(x1)
        fuse2 = fuse2 + F.interpolate(self.stage4_72_36_2(x3),size=[32,32], mode='nearest')
        fuse2 = fuse2 + F.interpolate(self.stage4_144_36_2(x4),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        fuse3 = fuse3 + x3
        fuse3 = fuse3 + F.interpolate(self.stage4_144_72_2(x4),size=[16,16], mode='nearest')
        fuse3 = self.relu(fuse3)
        ...
        # stage 4 fuse
        fuse1 = x1 + F.interpolate(self.stage4_36_18_3(x2),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage4_72_18_3(x3),size=[64,64], mode='nearest')
        fuse1 = fuse1 + F.interpolate(self.stage4_144_18_3(x4),size=[64,64], mode='nearest')
        fuse1 = self.relu(fuse1)

        fuse2 = self.stage4_18_36_3(x1)
        fuse2 = fuse2 + F.interpolate(self.stage4_72_36_3(x3),size=[32,32], mode='nearest')
        fuse2 = fuse2 + F.interpolate(self.stage4_144_36_3(x4),size=[32,32], mode='nearest')
        fuse2 = self.relu(fuse2)
        ...
        fuse3 = fuse3 + x3
        fuse3 = fuse3 + F.interpolate(self.stage4_144_72_3(x4),size=[16,16], mode='nearest')
        fuse3 = self.relu(fuse3)
        ...
        # # Head Part
        height, width = 64, 64
        # x1 = F.interpolate(out1, size=(height, width), mode='nearest', align_corners=False)
        # x2 = F.interpolate(out2, size=(height, width), mode='nearest', align_corners=False)
        # x3 = F.interpolate(out3, size=(height, width), mode='nearest', align_corners=False)
            
        x1 = F.interpolate(out1, size=(height, width), mode='nearest')
        x2 = F.interpolate(out2, size=(height, width), mode='nearest')
        x3 = F.interpolate(out3, size=(height, width), mode='nearest')
